...
class SuppliersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supplier" do
    assert_difference('Supplier.count') do
      post suppliers_url, params: { supplier: { address_id: @supplier.address_id, description: @supplier.description } }
    end
  ...
  test "should update supplier" do
    patch supplier_url(@supplier), params: { supplier: { address_id: @supplier.address_id, description: @supplier.description } }
