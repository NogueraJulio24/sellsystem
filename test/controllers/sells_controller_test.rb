...
class SellsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sell" do
    assert_difference('Sell.count') do
      post sells_url, params: { sell: { client_id: @sell.client_id, sell_date: @sell.sell_date } }
    end
  ...
  test "should update sell" do
    patch sell_url(@sell), params: { sell: { client_id: @sell.client_id, sell_date: @sell.sell_date } }
